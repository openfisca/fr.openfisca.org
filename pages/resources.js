...
const Resources = () => (
  <div className='content'>
    <ul className="flex__container">
      <li className="flex__item"><CardResources img="/static/icons/france.svg" title="Système : France" desc="Le système contient la majorité des impôts et des prestations sociales. 45 contributeurs au projet" linkexplorer="https://fr.openfisca.org/legislation"  linkgit="https://github.com/openfisca/openfisca-france"/></li>

      <li className="flex__item"><CardResources img="/static/icons/nz.svg" title="Système : Aotearoa Nouvelle-Zélande" desc="15 contributeurs au projet" linkexplorer="https://www.rules.nz"  linkgit="https://github.com/ServiceInnovationLab/openfisca-aotearoa"/></li>
